...
//
//glm::vec3 specularColor = glm::vec3(0.992157, 0.941176, 0.807843);  // brass
//#pragma endregion
//
...
//
//    "   float diffuseMultiplier = max(dot(lightDirection, fragNormal), 0.0);\n"
//    "   vec3 diffuseLight = diffuseMultiplier * materialColor;\n"
//
//    "   vec3 viewDirection = normalize(viewPosition - fragPosition);\n"
//    "   vec3 halfwayDirection = normalize(lightDirection + viewDirection);\n"
//
//    "   float specularMultiplier = pow(max(dot(fragNormal, halfwayDirection), 0.0), 10.0);\n"
//    "   vec3 specularLight = specularMultiplier * specularColor;\n"
//
...
//    glm::vec3 eye = glm::vec3(viewX, viewY, viewZ);
//
//    // camera position, look-at position, up vector
//    viewSphere = glm::lookAt(eye, glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
...
//    #pragma endregion
//
//    #pragma region // blinn-phong lighting
//    lightPosition = eye;
//
//    int lightLocation = glGetUniformLocation(shaderProgramSphere, "lightPosition");
//    //glUniform3f(lightLocation, lightPosition.x, lightPosition.y, lightPosition.z);
//    glUniform3f(lightLocation, lightX, lightY, 3.0f);
//
//    int viewPositionLocation = glGetUniformLocation(shaderProgramSphere, "viewPosition");
//    //glUniform3f(viewPositionLocation, eye.x, eye.y, eye.z);
//    glUniform3f(viewPositionLocation, 0.0f, 0.0f, 3.0f);
//
//    int specularColorLocation = glGetUniformLocation(shaderProgramSphere, "specularColor");
